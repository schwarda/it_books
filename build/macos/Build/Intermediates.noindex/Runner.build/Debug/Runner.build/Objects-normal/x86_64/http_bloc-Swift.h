...
#ifndef HTTP_BLOC_SWIFT_H
#define HTTP_BLOC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="http_bloc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9http_bloc11AppDelegate")
...
SWIFT_CLASS("_TtC9http_bloc17MainFlutterWindow")
